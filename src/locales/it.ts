export const it = {
  ...
  testimonials: {
    ...
    description: "Scopri perché i nostri ospiti continuano a tornare a Hotel Manegment System per le loro fughe al mare."
  },
  notFound: {
  ...
  home: {
    welcome: {
      subtitle: "Benvenuti a Hotel Manegment System",
      title: "Alloggi di Lusso sul Mare",
      description1: "Situato sulla incontaminata costa mediterranea, Hotel Manegment System offre una squisita collezione di appartamenti di lusso e camere d'albergo. I nostri alloggi fronte mare combinano un design elegante con comfort moderni, creando l'ambientazione perfetta per una indimenticabile fuga al mare.",
  ...
  amenitiesPage: {
    ...
    description: "A Hotel Manegment System, ci dedichiamo a fornire un'esperienza di soggiorno completa e lussuosa. Dai nostri servizi sulla spiaggia alle strutture di benessere, ogni dettaglio è stato curato per garantire il massimo comfort e piacere.",
    categories: {
      wellness: {
