            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-fade-in [animation-delay:300ms]">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden">
                  <img 
                    src="https://www.viceroyhotelsandresorts.com/sites/default/files/styles/large_card/public/2025-04/VHR-Viceroy-SugarBeach-Rooms-GrandLuxuryVilla-5c538575f2a09.jpg?h=fdad9bd4&itok=kCRDjfIoZ"
                    alt="Seaside view" 
                ...
                <div className="absolute -bottom-6 -left-6 w-2/3 rounded-2xl overflow-hidden shadow-xl">
                  <img 
                    src="https://media-cdn.tripadvisor.com/media/photo-o/01/bc/34/9f/the-ocean-lodge.jpg"
                ...
                <div className="absolute -top-6 -right-6 w-1/2 rounded-2xl overflow-hidden shadow-xl">
                  <img 
                    src="https://media-cdn.tripadvisor.com/media/photo-o/27/0f/a2/57/tolcarne-beach-village.jpg"
                    alt="Pool view" 
                    className="w-full h-full object-cover"
                  />
                </div>
