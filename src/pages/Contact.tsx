            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="animate-fade-in [animation-delay:100ms]">
                ...
                <div className="glass-card p-6 space-y-6 mb-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">+91 9510898935</p>
                      <p className="text-muted-foreground">+91 7874774369 (Reservations)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">shivam01809@gmail.com</p>
                    </div>
                  </div>
                ...
                <div className="aspect-video rounded-xl overflow-hidden">
                  <iframe  
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60343.05998295643!2d73.77912115354238!3d15.500654292335933!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfea4a0f09948d%3A0x9e1d18d60e1adffb!2sPanaji%2C%20Goa!5e0!3m2!1sen!2sin!4v1717759863527!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
